...
function bootstrap_pagination( ?WP_Query $wp_query = null, $echo = true, $params = [] ) {
    ...
    $pages = paginate_links( array_merge( [
            ...
            'mid_size'     => 1,
            'prev_next'    => true,
            'prev_text'    => __( '<i class="fa-solid fa-hand-point-left"></i> Prev' ),
            'next_text'    => __( 'Next <i class="fa-solid fa-hand-point-right"></i>' ),
            'add_args'     => $add_args,
            'add_fragment' => ''
        ], $params )
    );
    ...
    if ( is_array( $pages ) ) {
        ...
        $pagination = '<nav aria-label="Page navigation" class="custom-bs-pagination"><ul class="pagination">';
